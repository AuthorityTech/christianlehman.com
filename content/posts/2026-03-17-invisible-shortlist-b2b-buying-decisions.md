...
AuthorityTech's [Publication Intelligence Index](https://authoritytech.io/publications) tracks which publications are driving AI shortlist appearances in real time, by vertical. The pattern is consistent across every category we monitor: the publications at the top of that index are the ones that determine whether you show up when a buyer asks an AI who's worth calling.
